...
// FIX: Update icon components to accept any valid SVG props (like `title`) to resolve type errors
// and improve reusability by removing React.FC and explicitly typing props.
